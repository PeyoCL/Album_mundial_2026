...
window.uploadQRImage = function (event) {
    const file = event.target.files[0]; if (!file) return; loadQRLibraries(() => {
...
window.importData = function (e) {
    ...
    r.onload = (ev) => {
        try {
            ...
            // Caso 1: Es un respaldo Multi-Álbum moderno (v49/v50)
            if (d.albums) {
            ...
            // Caso 2: Es un respaldo clásico de un solo álbum (v48 o menor)
            else if (d.stickers) {
